        ...
        <q-scroll-area style="height: calc(100% - 150px); margin-top: 150px; border-right: 1px solid #ddd">
          <q-list padding>
            <q-item clickable v-ripple>
              ...
              <q-item-section>
                <router-link to="/klijent/MojProfilKlijent" class="text">
                  <p class="text-grey-10">Moj profil</p>
                </router-link>
              </q-item-section>
            </q-item>
            ...
            <q-item active clickable v-ripple>
              ...
              <q-item-section>
                <router-link to="/klijent/PocetnaKlijent" class="text">
                  <p class="text-grey-10">Pocetna</p>
                </router-link>
              </q-item-section>
            </q-item>
            ...
            <q-item clickable v-ripple>
              ...
              <q-item-section>
                <router-link to="/klijent/Nasa_Pomoc" class="text">
            ...
            <q-item clickable v-ripple>
              ...
              <q-item-section>
                <router-link to="/klijent/NasKalkulator" class="text">
                  <p class="text-grey-10">Kalkulator kalorija</p>
                </router-link>
              </q-item-section>
            </q-item>
    ...
    onMounted(() => {
      ...
      onAuthStateChanged(auth, async (user) => {
        if (user) {
          ...
          if (klijentiSnap.exists()) {
          
            ime_korisnika.value = klijentiSnap.data().ime_korisnika;
            email.value = user.email;
            shape.value = klijentiSnap.data().shape;
          } else {
            console.log('No such document for Klijenti!');
          }
        } else {
